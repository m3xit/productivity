...
public class TrainingView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.TrainingView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.TrainingView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.TrainingView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.TrainingView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.TrainingView_exampleDrawable);
